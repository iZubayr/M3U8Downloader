...
**M3U8 Downloader** — m3u8 formatidagi video strimlarni MP4 formatida yuklab olish uchun mo'ljallangan yengil WPF dasturi. Ko'plab saytlardagi video strimlar aynan `.m3u8` formatida uzatiladi — bu dastur ularni qulay tarzda yuklab olishga yordam beradi.
...
## ⚠️ Kamchiliklar (ma'lum muammolar)
...
```
M3U8Downloader.exe          ← asosiy dastur
